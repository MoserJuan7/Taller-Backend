...
def index():
    ...
    if name:
        ...
        if response.status_code != 200:
            return render_template("index.html", characters=[], search=True,
            error_message="Personaje no encontrado")
    ...
    return render_template("index.html", characters=data["results"], info=data["info"], 
    page=int(page), search=False)
